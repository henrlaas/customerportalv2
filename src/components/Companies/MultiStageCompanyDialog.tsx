...
import { Building, ChevronLeft, ChevronRight, Globe, Mail, MapPin, Phone, User } from 'lucide-react';
  ...
  const createCompanyMutation = useMutation<Company, Error, CompanyFormValues>({
    mutationFn: async (values: CompanyFormValues) => {
      ...
      const companyData = {
        ...
        // Only include MRR if Marketing is selected
        name: values.name,
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              field
                ...
                <FormField control={form.control} name="client_types" render={() => <FormItem>
                  ...
                  field
                      ...
                      const updated = checked ? [...current, CLIENT_TYPES.MARKETING] : current.filter(value => value !== CLIENT_TYPES.MARKETING);
                  ...
                  field
                      ...
                      const current = field.value || [];
                      const updated = checked ? [...current, CLIENT_TYPES.WEB] : current.filter(value => value !== CLIENT_TYPES.WEB);
            ...
            {stage === 2 && <>
              ...
              field
                ...
                <FormField control={form.control} name="invoice_email" render={({
              field
            }) => <FormItem>
                      <FormLabel className="flex items-center gap-2">
            ...
            {stage === 3 && <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField control={form.control} name="advisor_id" render={({
                field
              }) => <FormItem>
                        <FormLabel className="flex items-center gap-2">
                  ...
                  {hasMarketingType && <FormField control={form.control} name="mrr" render={({
                field
              }) => <FormItem>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField control={form.control} name="trial_period" render={({
                field
                  ...
                  <FormField control={form.control} name="is_partner" render={({
                field
              }) => <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
            ...
            <DialogFooter className="flex justify-between pt-4 sm:justify-between">
              <div>
                {stage > 1 && <Button type="button" variant="outline" onClick={goBack} className="flex items-center gap-1">
              ...
              <div className="flex gap-2">
                ...
                <Button type="submit" className={cn("flex items-center gap-1 bg-black hover:bg-black/90", stage === totalStages ? "" : "bg-black hover:bg-black/90")} disabled={createCompanyMutation.isPending}>
                  {createCompanyMutation.isPending ? 'Creating...' : stage === totalStages ? 'Create Company' : <>
