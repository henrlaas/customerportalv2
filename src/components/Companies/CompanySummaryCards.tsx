      ...
      <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            {company.is_marketing_client && company.mrr !== null && <div>
            ...
            <div className="flex flex-wrap gap-1">
              {company.trial_period && <Badge variant="outline" className="text-xs bg-orange-50 text-orange-700 border-orange-200">
                  Trial Active
                </Badge>}
              {!company.mrr && !company.trial_period && <p className="text-sm text-gray-500">No financial data</p>}
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            ...
            {company.invoice_email && <div className="flex items-center gap-2">
            ...
            {company.website && <div className="flex items-center gap-2">
            ...
            {!company.phone && !company.invoice_email && !company.website && <p className="text-sm text-gray-500">No contact info</p>}
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-purple-50 to-violet-50 border-purple-200">
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            ...
            {company.organization_number && <div>
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap gap-2">
              {company.is_partner && <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-300">
                  <Shield className="h-3 w-3 mr-1" />
                  Partner
                </Badge>}
              {company.is_marketing_client && <Badge variant="marketing" className="bg-green-50 text-green-700 border-green-300">
                  Marketing
                </Badge>}
              {company.is_web_client && <Badge variant="web" className="bg-purple-50 text-purple-700 border-purple-300">
                  Web
                </Badge>}
            </div>
            <div>
