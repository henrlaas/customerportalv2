  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem] flex items-center justify-center min-h-8",
        ...
        day: cn(
          ...
          "w-full aspect-square p-0 font-normal aria-selected:opacity-100 text-xs min-h-8 flex items-center justify-center"
        ),
