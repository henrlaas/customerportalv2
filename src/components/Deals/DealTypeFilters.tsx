    ...
    <div className="flex items-center gap-3">
      <Select value={recurringFilter} onValueChange={onRecurringFilterChange}>
        ...
        <SelectContent align="start">
          ...
          <SelectItem value="recurring" className="flex items-center gap-2 px-2">
            <div className="w-4 h-4 bg-blue-100 rounded flex items-center justify-center">
              <Repeat className="w-3 h-3 text-blue-600" />
            </div>
            <span>Recurring</span>
          </SelectItem>
          <SelectItem value="one-time" className="flex items-center gap-2 px-2">
      ...
      <Select value={clientTypeFilter} onValueChange={onClientTypeFilterChange}>
        ...
        <SelectContent align="start">
          ...
          <SelectItem value="marketing" className="flex items-center gap-2 px-2">
            <div className="w-4 h-4 bg-orange-100 rounded flex items-center justify-center">
              <Megaphone className="w-3 h-3 text-orange-600" />
            </div>
            <span>Marketing</span>
          </SelectItem>
          <SelectItem value="web" className="flex items-center gap-2 px-2">
