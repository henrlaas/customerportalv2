        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            <h4 className="font-medium text-gray-900">
              {isExistingCompany ? getCompanyName(deal.company_id, companies, null, deal.id) : tempCompany?.company_name || 'Unknown Company'}
            </h4>
            {!isExistingCompany && <Badge variant="outline" className="text-xs">Temporary

          </Badge>}
          </div>

          {/* Temp Company Details */}
          {tempCompany && <div className="space-y-2 text-sm">
              {tempCompany.organization_number && <div className="flex items-center justify-between">
              ...
              {tempCompany.website && <div className="flex items-center justify-between">
                  <span className="text-gray-600">Website:</span>
                  <div className="flex items-center gap-2">
                    <a href={tempCompany.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 flex items-center gap-1">
              ...
              {/* Address */}
              {(tempCompany.street_address || tempCompany.city) && <div className="space-y-1">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">
                  ...
                  {tempContact.position && <span className="text-gray-500 font-normal"> • {tempContact.position}</span>}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <a href={`mailto:${tempContact.email}`} className="text-blue-600 hover:text-blue-800 flex items-center gap-1">
              ...
              {tempContact.phone && <div className="flex items-center justify-between">
                  <span className="text-gray-600">Phone:</span>
                  <div className="flex items-center gap-2">
                    <a href={`tel:${tempContact.phone}`} className="text-blue-600 hover:text-blue-800 flex items-center gap-1">
