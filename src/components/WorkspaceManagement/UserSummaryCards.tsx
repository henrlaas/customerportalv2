    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
        ...
        <CardContent className="relative p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-blue-600 mt-1">System users</p>
            </div>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="relative p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-green-700">Employee Users</p>
              <p className="text-3xl font-bold text-green-900">{employeeUsers}</p>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="relative p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-purple-700">Client Users</p>
              <p className="text-3xl font-bold text-purple-900">{clientUsers}</p>
              <p className="text-xs text-purple-600 mt-1">External clients</p>
            </div>
