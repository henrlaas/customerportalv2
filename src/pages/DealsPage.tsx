...
const DealsPage = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-shrink-0 p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      {/* Kanban view container with proper height constraint */}
      <div className="flex-1 px-4 sm:px-6 lg:px-8 pb-4 sm:pb-6 lg:pb-8 overflow-hidden">
        {isLoading ? (
