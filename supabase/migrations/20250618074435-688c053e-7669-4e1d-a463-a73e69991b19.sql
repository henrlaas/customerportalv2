...
SELECT cron.schedule(
  ...
  SELECT
    net.http_post(
        ...
        headers:='{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZqcWJnbmpldXV4dnVydWV3eWMiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc0Mzk1MDkwMiwiZXhwIjoyMDU5NTI2OTAyfQ.MvXDNmHq771t4TbZrrnaylqBoTcEONv0qv31sZYmAA8"}'::jsonb,
...
SELECT cron.schedule(
  ...
  '0 10 28-31 * *', -- Days 28-31 of every month at 10:00 AM UTC
  $$
  SELECT
    net.http_post(
